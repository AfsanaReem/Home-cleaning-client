...
const UpdateReview = () => {
    ...
    const { _id, title, price, review } = useLoaderData();
    console.log(_id);
    const date = new Date();
    const handleUpdateReview = event => {
        ...
        fetch(`https://home-cleaning-service-server.vercel.app/reviews/${_id}`, {
            method: 'PUT',
            headers: {
        ...
        <div>
            <form onSubmit={handleUpdateReview}>
                <div className='mx-60 my-24'>
                    <h1 className='text-center text-4xl mb-4'>Update Your Review</h1>
                    <div className='grid grid-cols-1 lg:grid-cols-1 gap-4'>
                        ...
                        <input name="review" defaultValue={review} type="text" placeholder="Your Review" className="input input-ghost w-full h-20 input-bordered" required />
                    </div>
                    <br />
